...
{
    public class ColorShifterComponent : MonoBehaviour
    {
        //Fields - configurable
        ...
        //Constructors
        //public ColorShifterComponent(string pName, Transform pTransform, SpriteRenderer pRenderer, float pShiftSpeed) : base(pName, pTransform, pRenderer)
        //{
        //}

        public ColorShifterComponent(string pName, Transform _transfrom, GraphicsDeviceManager _graphics, float pShiftSpeed) : base(_transfrom, _graphics)
        {
        ...
        public override void Update(GameTime pGameTime)
        {
            ...
            sr.Color = HSLToRGB(_hue, 1.0f, 0.5f);
        }
